...
@Component({
  selector: 'app-project-cancelled',
  templateUrl: './project-cancelled.component.html',
  styleUrls: ['./project-cancelled.component.scss']
})
export class ProjectCancelledComponent implements OnInit, OnDestroy
{
  private sub: any;
  public dataList: any = [];
  ...
  {
    this.sub = this.aService.GetProjectCancelledList().subscribe(x =>
    {
      this.dataList = x;
    });
  }
